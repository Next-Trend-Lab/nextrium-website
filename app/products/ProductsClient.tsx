...
type FilterStatus = 'all' | 'in_development' | 'beta' | 'live' | 'sunset'
      ...
      <style>{`
        ...
        .products-hero-glow {
          ...
          background:
            ...
            radial-gradient(ellipse 40% 50% at 5% 90%, rgba(10,139,139,0.06) 0%, transparent 50%);
        }
        .products-hero-grid {
        ...
        .products-sub {
          ...
          color: var(--grey-mid); line-height: 1.7; max-width: 520px;
        ...
        .product-name {
          ...
          font-size: 22px; color: var(--white); letter-spacing: -0.3px; line-height: 1.2;
        }
        ...
        .product-link {
          ...
          cursor: pointer; /* ensure pointer cursor for non‑anchor element */
        }
        ...
        <div className="container">
                    ...
                    <div className="product-links">
                      ...
                      {product.github_url && (
                        <span
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            window.open(product.github_url, '_blank', 'noopener,noreferrer');
                          }}
                          onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                              e.stopPropagation();
          ...
          <div className="products-note">
            <div className="products-note-inner">
              <span className="products-note-text">
                More builds coming. This list grows as NexTrium ships.
              </span>
              <Link href="/contact?subject=partnership" className="products-note-cta">
                Partner with us →
              </Link>
            </div>
          </div>
