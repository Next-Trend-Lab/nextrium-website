  ...
  return (
    <>
      <style>{`
        ...
        .event-hero { background: var(--navy-deep); padding-top: calc(var(--nav-height) + 80px); padding-bottom: 80px; position: relative; overflow: hidden; border-bottom: 1px solid rgba(255,255,255,0.05); }
        ...
        .event-hero-inner { position: relative; z-index: 1; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: end; }
        ...
        .event-social-link { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 10px 14px; border: 1px solid var(--grey-light); color: var(--grey-dark); text-decoration: none; font-size: 12px; transition: all var(--transition-base); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .event-social-link:hover { border-color: var(--navy); color: var(--navy-deep); }
        .event-youtube-wrap { width: 100%; aspect-ratio: 16/9; margin-bottom: 32px; }
        .event-youtube-wrap iframe { width: 100%; height: 100%; border: none; }
        ...
        @media (max-width: 900px) { .event-hero-inner { grid-template-columns: 1fr; gap: 40px; } .event-body-grid { grid-template-columns: 1fr; gap: 40px; } .event-sidebar { position: static; } .related-grid { grid-template-columns: 1fr; } }
        @media (max-width: 600px) { .event-detail-row { grid-template-columns: 1fr; gap: 2px; } }
      `}</style>
        ...
        <div className="container">
          <div className="event-body-grid">
            <div>
              ...
              <div className="event-desc-title">What happened.</div>
